 ...
 * @author IFMA
 */
public class GPessoas extends javax.swing.JFrame {

    /**
     * Creates new form GPessoas
     */
    public GPessoas() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        GPCriar obj = new GPCriar();
        obj.setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        GPListar obj = new GPListar();
        obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GPessoas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
